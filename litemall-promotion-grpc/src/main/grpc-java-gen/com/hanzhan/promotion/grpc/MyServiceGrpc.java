...
@javax.annotation.Generated(
    ...
    comments = "Source: serv.proto")
public final class MyServiceGrpc {

  private MyServiceGrpc() {}

  public static final String SERVICE_NAME = "com.hanzhan.promotion.grpc.MyService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.hanzhan.promotion.grpc.HelloRequest,
      com.hanzhan.promotion.grpc.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.hanzhan.promotion.grpc.HelloRequest.class,
      responseType = com.hanzhan.promotion.grpc.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.hanzhan.promotion.grpc.HelloRequest,
      com.hanzhan.promotion.grpc.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.hanzhan.promotion.grpc.HelloRequest, com.hanzhan.promotion.grpc.HelloReply> getSayHelloMethod;
      ...
      synchronized (MyServiceGrpc.class) {
        if ((getSayHelloMethod = MyServiceGrpc.getSayHelloMethod) == null) {
          MyServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.hanzhan.promotion.grpc.HelloRequest, com.hanzhan.promotion.grpc.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hanzhan.promotion.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hanzhan.promotion.grpc.HelloReply.getDefaultInstance()))
  ...
  public static abstract class MyServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(com.hanzhan.promotion.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.hanzhan.promotion.grpc.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.hanzhan.promotion.grpc.HelloRequest,
                com.hanzhan.promotion.grpc.HelloReply>(
  ...
  public static final class MyServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MyServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.hanzhan.promotion.grpc.HelloReply sayHello(com.hanzhan.promotion.grpc.HelloRequest request) {
  ...
  public static final class MyServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MyServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.hanzhan.promotion.grpc.HelloReply> sayHello(
        com.hanzhan.promotion.grpc.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.hanzhan.promotion.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.hanzhan.promotion.grpc.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class MyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.hanzhan.promotion.grpc.HelloWorldProto.getDescriptor();
    }
